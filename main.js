const quizData = {
  ...
  workSliders: {
    A: [ // 남진우
      { left: '천사', right: '악마', defaultVal: 50 },
      { left: '평온함', right: '화려함', defaultVal: 50 },
      { left: '입체', right: '평면', defaultVal: 50 },
    ],
    B: [ // 고등어
      { left: '고요함', right: '시끄러움', defaultVal: 50 },
      { left: '긴박함', right: '일상적', defaultVal: 50 },
      { left: '재밌음', right: '지루함', defaultVal: 50 },
    ],
    C: [ // 김우진
      { left: '평온함', right: '무서움', defaultVal: 50 },
      { left: '고요함', right: '불안함', defaultVal: 50 },
      { left: '유령', right: '바다', defaultVal: 50 },
    ],
    D: [ // 김지은
      { left: '편안함', right: '답답함', defaultVal: 50 },
      { left: '정리된', right: '통제된', defaultVal: 50 },
      { left: '거지', right: '부자', defaultVal: 50 },
    ],
    E: [ // 정세인
      { left: '드러난', right: '감춰진', defaultVal: 50 },
      { left: '감성적', right: '이성적', defaultVal: 50 },
      { left: 'LOVE', right: 'ONLY', defaultVal: 50 },
    ],
    F: [ // 문소현
      { left: '빛', right: '어둠', defaultVal: 50 },
      { left: '화련한', right: '공허한', defaultVal: 50 },
      { left: '천국', right: '지옥', defaultVal: 50 },
    ],
    G: [ // 박소라
      { left: '알약', right: '비누', defaultVal: 50 },
      { left: '편안함', right: '답답함', defaultVal: 50 },
      { left: '커피', right: '에너지 드링크', defaultVal: 50 },
    ],
    H: [ // 김정우
      { left: '밝음', right: '어두움', defaultVal: 50 },
      { left: '발랄함', right: '외로움', defaultVal: 50 },
      { left: '안전한', right: '위험한', defaultVal: 50 },
    ],
    I: [ // 천경우
      { left: '사진', right: '그림', defaultVal: 50 },
      { left: '공감', right: '비공감', defaultVal: 50 },
      { left: '흑백', right: '컬러', defaultVal: 50 },
    ],
    J: [ // 장서영
      { left: '편안한', right: '갑갑한', defaultVal: 50 },
      { left: '자유로운', right: '단절된', defaultVal: 50 },
      { left: '여행', right: '집콕', defaultVal: 50 },
    ],
    K: [ // 권순관
      { left: '자유로운', right: '감시받는', defaultVal: 50 },
      { left: '개인', right: '단체', defaultVal: 50 },
      { left: '버스', right: '지하철', defaultVal: 50 },
    ],
    L: [ // 최병석
    ...
    M: [ // 김승주
      { left: '자', right: '피아노', defaultVal: 50 },
      { left: '재밌음', right: '혼란스러움', defaultVal: 50 },
      { left: '새로운', right: '불편한', defaultVal: 50 },
    ],
    N: [ // 잭슨홍
      { left: '안전한', right: '위험한', defaultVal: 50 },
    ...
    O: [ // 김승영
      { left: '뇌', right: '저울', defaultVal: 50 },
      { left: '징그러움', right: '멋있음', defaultVal: 50 },
      { left: '가벼운', right: '무거운', defaultVal: 50 },
    ],
  },
  workOptions: {
    far: [
  ...
  results: {
    ...
    // 1단계 1번 질문 (조용히 해야 한다) — 긍정 (편안함5 / 행복함5 / 당당함5)
    ...
    S6: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    S7: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    S8: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    S9: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    S10: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    S11: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    S12: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    S13: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    S14: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    S15: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    // 1단계 1번 질문 — 부정 (답답함4 / 짜증남4 / 불쾌함3 / 어색함2 / 강렬함2)
    S16: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    ...
    S22: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    ...
    S28: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    S29: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    S30: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    // 1단계 2번 질문 (뛰면 안 된다) — 긍정 (편안함5 / 행복함5 / 당당함5)
    ...
    R5: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    R6: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    R7: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    R8: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    R9: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    R10: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    R11: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    R12: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    R13: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    R14: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    R15: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    // 1단계 2번 질문 — 부정 (답답함4 / 짜증남4 / 불쾌함3 / 어색함2 / 강렬함2)
    ...
    R19: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    R20: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    R21: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    R22: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    R23: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    R24: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    R25: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    R26: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    R27: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    R28: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    R29: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    R30: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    // 1단계 3번 질문 (음식물 반입 금지) — ① 긍정 (편안함5 / 행복함5 / 당당함5)
    F1: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    F2: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    F3: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    F4: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    F5: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    F6: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    F7: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    F8: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    F9: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    F10: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    F11: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    F12: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    F13: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    F14: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    F15: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    // 1단계 3번 질문 — ② 부정 (답답함4 / 짜증남4 / 불쾌함3 / 어색함2 / 강렬함2)
    F16: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    F17: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    F18: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    F19: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    F20: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    F21: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    F22: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    F23: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    F24: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    F25: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    // 1단계 3번 질문 — ③ 중립·양가
    F26: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    F27: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    F28: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    F29: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    F30: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    ...
    // Q4 다른 사람이 작품 — 부정15(답답함3·짜증남3·불쾌함3·어색함3·강렬함3) / 긍정15(편안함5·행복함5·당당함5)
    ...
    V13: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    V14: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    V15: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    V16: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    ...
    V20: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    V21: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    V22: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    V23: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    V24: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    V25: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    V26: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    V27: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    V28: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    V29: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    V30: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    // Q5 작품 이해 — 긍정15(편안함5·행복함5·당당함5) / 부정15(답답함3·짜증남3·불쾌함3·어색함3·강렬함3)
    W1: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    W2: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    W3: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    W4: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    W5: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    ...
    W10: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    W11: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    W12: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    W13: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    W14: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    W15: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    W16: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    W17: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    W18: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    W19: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    W20: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    W21: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    W22: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    W23: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    W24: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    W25: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    ...
    W30: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    // Q6 옷 고민 — 부정15(답답함3·짜증남3·불쾌함3·어색함3·강렬함3) / 긍정15(편안함5·행복함5·당당함5)
    X1: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    X2: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    X3: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    X4: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    ...
    X9: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    X10: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    X11: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    X12: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    X13: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    X14: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    ...
    X18: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    ...
    X22: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    X23: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    X24: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    X25: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    X26: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    X27: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    X28: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    X29: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    ...
    // 이모지 감정 — 8가지 균등 배분 (😊편안 😍행복 🤩행복 🧐당당 😎당당 😢답답 🫨강렬 😴짜증 😵불쾌 🤔어색)
    EM1: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    EM2: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    EM3: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    EM4: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    EM5: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    EM6: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    EM7: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    EM8: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
    EM9: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    EM10: { type: '어색함', description: '손 어디 둬야 할지 고민되는 자세 방황형' },
    // captionEmotion — 편안함6 / 당당함9 / 행복함4 / 강렬함5 / 답답함2 / 짜증남1 / 어색함2 / 불쾌함1
    CP1: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    CP2: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    CP3: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    CP4: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    CP5: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    CP6: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    CP7: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    CP8: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    CP9: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    CP10: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    CP11: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    CP12: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    CP13: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    CP14: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    CP15: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    CP16: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    ...
    CP20: { type: '당당함', description: '눈치 안 보고 자기 템포 유지하는 마이웨이형' },
    CP21: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    CP22: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    CP23: { type: '행복함', description: '괜히 기분 좋아지는, 이유 없는 만족형' },
    CP24: { type: '편안함', description: '들어오자마자 긴장 해제되는, 미술관 힐링형' },
    CP25: { type: '강렬함', description: '괜히 더 의식돼서 긴장감 도는 집중 과부하형' },
    CP26: { type: '불쾌함', description: '규칙 많은 공간에 예민해지는 제한 회피형' },
    CP27: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    CP28: { type: '답답함', description: '벽이 점점 가까워지는 느낌, 탈출 욕구형' },
    CP29: { type: '짜증남', description: "'조용히 하세요'에 살짝 반감 드는 자유 추구형" },
...
// 긍정: 편안함·행복함·당당함 / 부정: 답답함·짜증남·불쾌함·어색함 / 강렬: 강렬함
const SLIDER_LABEL_TO_TYPE = {
  // 공통
  편안함: '편안함', 편안한: '편안함', 답답함: '답답함', 갑갑한: '답답함',
  불편함: '불쾌함', 불편한: '불쾌함', 재밌음: '행복함', 안전한: '편안함', 위험한: '불쾌함',
  자유로운: '행복함', 감시받는: '불쾌함', 단절된: '답답함',
  // A 남진우: 천사/악마, 평온함/화려함, 입체/평면
  천사: '편안함', 악마: '불쾌함',
  평온함: '편안함', 화려함: '강렬함',
  입체: '강렬함', 평면: '편안함',
  // B 고등어: 고요함/시끄러움, 긴박함/일상적, 재밌음/지루함
  고요함: '편안함', 시끄러움: '짜증남',
  긴박함: '강렬함', 일상적: '편안함',
  지루함: '짜증남',
  // C 김우진: 평온함/무서움, 고요함/불안함, 유령/바다
  무서움: '불쾌함', 불안함: '답답함',
  유령: '강렬함', 바다: '편안함',
  // D 김지은: 편안함/답답함, 정리된/통제된, 거지/부자
  정리된: '편안함', 통제된: '답답함',
  거지: '답답함', 부자: '행복함',
  // E 정세인: 드러난/감춰진, 감성적/이성적, LOVE/ONLY
  드러난: '당당함', 감춰진: '어색함',
  감성적: '강렬함', 이성적: '편안함',
  LOVE: '행복함', ONLY: '강렬함',
  // F 문소현: 빛/어둠, 화련한/공허한, 천국/지옥
  빛: '편안함', 어둠: '불쾌함',
  화련한: '행복함', 공허한: '답답함',
  천국: '행복함', 지옥: '불쾌함',
  // G 박소라: 알약/비누, 편안함/답답함, 커피/에너지 드링크
  알약: '편안함', 비누: '편안함',
  커피: '편안함', '에너지 드링크': '강렬함',
  // H 김정우: 밝음/어두움, 발랄함/외로움, 안전한/위험한
  밝음: '편안함', 어두움: '강렬함',
  발랄함: '행복함', 외로움: '답답함',
  // I 천경우: 사진/그림, 공감/비공감, 흑백/컬러
  사진: '편안함', 그림: '행복함',
  공감: '편안함', 비공감: '어색함',
  흑백: '강렬함', 컬러: '행복함',
  // J 장서영: 편안한/갑갑한, 자유로운/단절된, 여행/집콕
  여행: '행복함', 집콕: '편안함',
  // K 권순관: 자유로운/감시받는, 개인/단체, 버스/지하철
  개인: '당당함', 단체: '어색함',
  버스: '편안함', 지하철: '어색함',
  // L 최병석: 쓸모/무쓸모, 과학자/괴짜, 재밌음/불편함
  쓸모: '당당함', 무쓸모: '답답함',
  과학자: '당당함', 괴짜: '당당함',
  // M 김승주: 자/피아노, 재밌음/혼란스러움, 새로운/불편한
  자: '편안함', 피아노: '행복함',
  혼란스러움: '답답함', 새로운: '강렬함',
  // N 잭슨홍: 안전한/위험한, 흰 글씨/빨간 글씨, 재밌음/불편함
  '흰 글씨': '편안함', '빨간 글씨': '불쾌함',
  // O 김승영: 뇌/저울, 징그러움/멋있음, 가벼운/무거운
  뇌: '강렬함', 저울: '편안함',
  징그러움: '불쾌함', 멋있음: '당당함',
  가벼운: '편안함', 무거운: '답답함',
};
